...
//array:-
let array1:string[]=["ali","Shan","Nadia"];//strongly type
console.log(array1);

let arry2=[23,45,87,12];//inferring
console.log(arry2);

let arry3:(string | number | boolean | {
    name: string;
    age: number;
})[]=[12,45,"sania","pakistan",true,{name:"Rehan",age:45}]; //mixes data type

//tuple-data typed- array

let arr3:[string,boolean,string,number,{name:string,quarter:number}]=["Sania",false,"karacchi",45,{name:"Ahmed",quarter:2}]
console.log(arr3);
