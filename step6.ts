...
let myname: unknown = "Zia Khan";

let a=(myname as string)//typecasting through type exxpression
...
console.log((<string> myname).length)//This uses angle brackets (<string>) to assert that myname is a string. This is an alternative syntax for type assertions, and it achieves the same result as the first example.
