...
//1- creates a newly array by doing some operations.
...
let newarraybymap=(arr1.map(elem=>elem+10//you can do here all mathematics operations and numeric methods
) );
