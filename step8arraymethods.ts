//readme
let str_array:string[]=["Saira","Sana","zameer","ayesha"];
let num_array:number[]=[5,10,15,20,25,30];
...
//o/p ====175- true
//------------------------------------------------
let names:string[]=["ALi", "Sahir","Sana"];
...
//------------------------------------------------------------------
let str_array1:string[]=["Saira","Sana","zameer","ayesha"];
