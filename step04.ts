...
let myname: string | null;//union type is a combination of several data types into a single type, denoted by |.
...
function isNumber(x: any): x is number {
  ...
  let x: number | string = 10;//union type
...
const stringValue = value2 as string;//type assertion-forcfully-narrowing through type casting.
console.log(stringValue.toUpperCase()); // okay

//3. Control Flow Analysis

let value3: string | number = "world";
...
//LITERALS TYPE
let zia: "zia"; //let zia: "zia"; declares a variable zia with a literal type that can only be the string "zia". This means that zia can only be assigned the value "zia", and no other value.
...
// The optional chaining operator (?.) is used to call toUpperCase() on yourName only if it is not undefined or null. If yourName is undefined, the expression will return undefined instead of throwing an error. This is why the code is okay.

//or

//yourName.toUpperCase();//Error: Object is possibly 'undefined'.

//If we try to call toUpperCase() directly on yourName without the if statement, TypeScript will throw an error. This is because yourName could potentially be undefined, and you can't call methods on undefined.

//-------------------------------------------------------------------------------------------
// You can also define a type alias
type RawData = boolean | number | string | null | undefined;

let data: RawData;// as a nick name for broad union type

// You can even combine them

type Id = number | string;
type Id1= undefined | null; 
