...
let myval:any;  // here we ddeclare a variable.
...
let val: unknown;  //parent variable or main variable.

const val1: unknown = val; // OK-- Assigning a value of type unknown to a variable of type unknown is allowed.

const val2: any = val; // OK--Assigning a value of type unknown to a variable of type any is allowed, because any is a supertype of unknown.

const val3: boolean = val; // Will throw error---Assigning a value of type unknown to a variable of type boolean will throw a type error, because unknown is not a subtype of boolean.

const val4: number = val; // Will throw error-- Assigning a value of type unknown to a variable of type number will throw a type error, because unknown is not a subtype of number.

const val5: string = val; // Will throw error--Assigning a value of type unknown to a variable of type string will throw a type error, because unknown is not a subtype of string.

const val6: Record<string, any> = val; // Will throw error--Assigning a value of type unknown to a variable of type Record<string, any> will throw a type error, because unknown is not a subtype of Record<string, any>.


const val7: any[] = val; // Will throw error-- Assigning a value of type unknown to a variable of type any[] will throw a type error, because unknown is not a subtype of any[].

const val8: (...args: any[]) => void = val; // Will throw error--8. Assigning a value of type unknown to a variable of type (...args: any[]) => void will throw a type error, because unknown is not a subtype of (...args: any[]) => void.
