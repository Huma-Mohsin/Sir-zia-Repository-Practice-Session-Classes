...
greeter((a) => console.log(a)); // we are passing the greet function itself as an argument to greeter, not the result of calling greet(). This is why we don't use parentheses () with greet when passing it as an argument.
